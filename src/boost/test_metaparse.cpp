        ...
        transform<
            ...
            boost::mpl::lambda<
                boost::mpl::fold<
                    boost::mpl::_1,
                    boost::mpl::int_<0>,
                    boost::mpl::quote2<sum_items>>>::type>>>;
...
class sum_vector : boost::mpl::fold<
                       ...
                       boost::mpl::int_<0>,
                       boost::mpl::lambda<
                           boost::mpl::plus<boost::mpl::_1, boost::mpl::_2>>::type> {};
...
template <class L, char OP, class R>
struct eval_binary_op;
template <class L, class R>
struct eval_binary_op<L, '+', R> : boost::mpl::plus<L, R>::type {};
template <class L, class R>
struct eval_binary_op<L, '-', R> : boost::mpl::minus<L, R>::type {};
...
// add times operator
template <class L, class R>
struct eval_binary_op<L, '*', R> : boost::mpl::times<L, R>::type {};
...
template <class L, class R>
struct eval_binary_op<L, '/', R> : boost::mpl::divides<L, R>::type {};
